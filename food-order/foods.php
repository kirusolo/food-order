...
<?php include('partials-front/menu.php'); ?>
    ...
    <section class="food-menu">
        <div class="container">
            ...
            $sql = "SELECT tbl_food.*, tbl_category.restaurant_id, tbl_resturant.resturant_name FROM tbl_food, tbl_category, tbl_resturant WHERE tbl_category.id = tbl_food.category_id AND tbl_resturant.id = tbl_category.restaurant_id AND tbl_food.active='Yes' AND tbl_food.featured='Yes' LIMIT 9";
            //execute the query
